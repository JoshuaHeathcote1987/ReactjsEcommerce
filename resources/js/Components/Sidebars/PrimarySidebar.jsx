...
export function PrimarySidebar({ colspan }) {
    return <aside className={`w-full flex flex-col max-h-full col-span-${colspan}`} aria-label="Sidebar">
        <div className="px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800 flex-1 ">
                    ...
                    <Dropdown>
                        <Dropdown.Trigger>
                            <button type="button" className="flex items-center w-full p-2 text-base font-normal text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700" aria-controls="dropdown-example" data-collapse-toggle="dropdown-example">
                                ...
                                <span className="flex-1 ml-3 text-left whitespace-nowrap" sidebar-toggle-item>Drop Down</span>
                                <svg sidebar-toggle-item className="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
                            </button>
                        </Dropdown.Trigger>
                        <Dropdown.Content>
                            <Dropdown.Link  href={'#'}>
