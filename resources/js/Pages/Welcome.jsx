                ...
                <div className="max-w-7xl mx-auto">
                    <div className="grid grid-cols-3 gap-5">
                        {products.map((item, index) => (
                            ...
                            <div key={item.id} className="w-full rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                                <a href="#">
                                    <img className="rounded-t-lg w-100" src={item.img} alt="product image" />
                                </a>
                                <div className="px-5 pb-5">
                                    <a href="#">
                                        <h5 className="text-3xl font-semibold tracking-tight text-gray-900 dark:text-white mt-3">{item.name}</h5>
                                    </a>
